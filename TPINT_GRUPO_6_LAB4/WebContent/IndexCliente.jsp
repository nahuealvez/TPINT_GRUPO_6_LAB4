	<div class="d-flex flex-column gap-3">
		...
		<div class="d-flex flex-column gap-4">
			<section>
				...
				<div class="d-flex gap-3">
					<div class="card" style="width: 18rem;">
					  <div class="card-body">
					    <h5 class="card-title">Caja de ahorros</h5>
					    <h6 class="card-subtitle mb-2 text-body-secondary">Nro de cuenta: 1</h6>
					    <p class="card-text">$123.456,00</p>
					  </div>
			...
			<section>		
				<h3 class="pb-2">Accesos rápidos</h3>
				<div class="d-flex">
					<a class="card-accesos">
						...
						<p>Pago de cuotas de préstamos</p>
					</a>
				</div>
			</section>
		</div>
