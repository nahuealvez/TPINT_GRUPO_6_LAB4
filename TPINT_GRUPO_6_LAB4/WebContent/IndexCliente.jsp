							...
							<div class="card" style="width: 18rem;">
							  ...
							  <div class="card-footer">
							  	<form action="ServletReporte" method="get">
							  		...
							  		<button type="submit" class="card-link d-flex gap-2 align-items-center m-0 btn btn-link p-0" style="text-decoration: none;" id="btnVerMovimientosCta" name="btnVerMovimientosCta">
