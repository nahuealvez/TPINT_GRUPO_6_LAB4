...
<body class="body-login">
    <div class="login-container">
        <div class="image-container-login">
            <h2>No rompas más chanchitos.</h2>
            <h2 class="sub">Traé tus ahorros a Piggy Bank.</h2>
        </div>
        <div class="form-container-login gap-3 pt-5">
        	<div class="d-flex flex-column pt-5">
        		<div class="h-5 mt-5"></div>
        		<div class="d-flex gap-2 flex-row align-items-center justify-content-center mb-4">
            ...
            <div>
        		<p style="font-size: 16px;">Todos los derechos reservados | 2024<p>
        	</div>
        </div>
